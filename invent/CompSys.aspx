<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompSys.aspx.cs" Inherits="CompSys" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="View4" runat="server">
            ...
            <table class="w-100">
                ...
                <tr>
                    <asp:GridView ID="GridView4" Width="100%" runat="server" BackColor="#DEBA84" 
                        BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        CellSpacing="2">
                        <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                        <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
        ...
        <asp:View ID="View5" runat="server">
         <table class="w-100">
                ...
                <tr>
                    <asp:GridView ID="GridView5" Width="100%" runat="server" BackColor="#DEBA84" 
                        BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        CellSpacing="2">
                        <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                        <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
        ...
        <asp:View ID="View6" runat="server">
         ...
         <table class="w-100">
                <tr>
                    <td class="text-sm-center" 
                        style="font-size: medium; text-decoration: underline">
                        <strong>SOFT DOME2</strong></td>
                </tr>
                <tr>
                    <asp:GridView ID="GridView6" Width="100%" runat="server" BackColor="#DEBA84" 
                        BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        CellSpacing="2">
                        <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                        <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
        ...
        <asp:View ID="View7" runat="server">
         ...
         <table class="w-100">
                ...
                <tr>
                    <asp:GridView ID="GridView7" Width="100%" runat="server" BackColor="#DEBA84" 
                        BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        CellSpacing="2">
                        <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                        <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
