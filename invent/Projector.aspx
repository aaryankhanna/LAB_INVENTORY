<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Projector.aspx.cs" Inherits="Projector" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="View2" runat="server">
         <table class="w-100">
            ...
            <td style="font-size: medium; text-decoration: underline">
                        ...
                        <asp:GridView ID="GridView7" runat="server" BackColor="#DEBA84" 
                            BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        ...
        <asp:View ID="View3" runat="server">
          ...
          <table class="w-100">
                <tr>
                 <td style="font-size: medium; text-decoration: underline">
                        <strong>MEGA TRENDS<br />
                        <asp:GridView ID="GridView10" runat="server" BackColor="#DEBA84" 
                            BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                            CellSpacing="2" Width="100%">
                            <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                            <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
        ...
        <asp:View ID="View4" runat="server">
           <table class="w-100">
                <tr>
                 <td style="font-size: medium; text-decoration: underline">
                        <strong>ZONE OF EXPLORATION<asp:GridView ID="GridView9" runat="server" 
